 ...
 * @version 0.9.1
 */
public class ConfigPrinterPanel extends JPanel implements ListSelectionListener {
    public ConfigPrinterPanel() {
        try {
            jbInit();
        } catch (Exception ex) {
            ex.printStackTrace();
    ...
    public ConfigPrinterPanel(JFrame parent) {
        this.parent = parent;
    ...
    private void jbInit() throws Exception {
        ...
        if (root.getNodeName().equals("JposEntries")) {
            ...
            for (int i = 0; i < nodes.getLength(); i++) {
                ...
                if (jpos.getLength() > 0) {
                    ...
                    if (category != null &&
                        category.getNodeValue().equals("POSPrinter")) {
        ...
        String vendor = Configuration.get("printer.vendor");
        ...
        jButton1.addActionListener(new
                                   ConfigPrinterPanel_jButton1_actionAdapter(this));
        jCheckBox1.setText(I18N.getLabelString("No printer"));
        if (model == null) {
    ...
    public void jButton1_actionPerformed(ActionEvent e) {
        if (jCheckBox1.isSelected()) {
            Configuration.delete("printer.vendor");
            Configuration.delete("printer.model");
            JOptionPane.showMessageDialog(parent,
                    I18N.getMessageString("Your printer settings have been changed."),
        ...
        if (vendor == null || model == null) {
            JOptionPane.showMessageDialog(parent,
                                          I18N.getLabelString("Please select a printer model."),
                                          I18N.getLabelString("Error"), JOptionPane.ERROR_MESSAGE);
            return;
        }

        Configuration.set("printer.vendor", vendor);
        Configuration.set("printer.model", model);
        JOptionPane.showMessageDialog(parent,
                I18N.getLabelString("Your printer settings have been changed."),
                                      I18N.getLabelString("Message"),
                                      JOptionPane.INFORMATION_MESSAGE);
    }
...
class ConfigPrinterPanel_jButton1_actionAdapter implements ActionListener {
    private ConfigPrinterPanel adaptee;
    ConfigPrinterPanel_jButton1_actionAdapter(ConfigPrinterPanel adaptee) {
