...
public class NewSalePanel extends JPanel implements TableModelListener {
    ...
    private void jbInit() throws Exception {
        ...
        titledBorder2 = new TitledBorder(BorderFactory.createEtchedBorder(Color.white, new Color(148, 145, 140)), "New Sale");
        ...
        try {
            ...
            for (int i = 0; i < rowCount; i++) {
                products[i] = new OrderProduct((String) model.getValueAt(i, 5),
                        ...
                        ((Double) model.getValueAt(i, 2)).doubleValue(),
                        ((Double) model.getValueAt(i, 3)).doubleValue(),
                        ((Integer) model.getValueAt(i, 4)).intValue());
            }
