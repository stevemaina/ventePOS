 ...
 * @version 0.9.1
 */
public class ReportsDailyPanel extends JPanel {
    public ReportsDailyPanel(JFrame parent) {
        this.parent = parent;
    ...
    private void jbInit() throws Exception {
        ...
        jLabel1.setText(I18N.getLabelString("Date") + ": ");
        ...
        jButton1.addActionListener(new ReportsDailyPanel_jButton1_actionAdapter(this));
        jButton2.setMnemonic('P');
        jButton2.setText(I18N.getButtonString("Print"));
        jButton2.addActionListener(new ReportsDailyPanel_jButton2_actionAdapter(this));
        jButton3.setMnemonic('G');
        jButton3.setText(I18N.getButtonString("Go"));
        jButton3.addActionListener(new ReportsDailyPanel_jButton3_actionAdapter(this));
    ...
    private void setDate(Date date) {
        DailyReport dp = new DailyReport(date);
        Hashtable totals = dp.getTotals();
        //Hashtable payTotals = dp.getPaymentTotals();
        ...
        Map.Entry[] stationEntries = Sorter.getSortedHashtableEntries(
                stationTotals, false);
        //Map.Entry[] payEntries = Sorter.getSortedHashtableEntries(payTotals, false);
        ...
        SimpleDateFormat df = new SimpleDateFormat("MM/dd/yyyy");
        report = I18N.getLabelString("Daily Report")+" " + df.format(date) + "\n\n";
        ...
        piePanel1.revalidate();
        piePanel1.repaint();
        piePanel2.revalidate();
        piePanel2.repaint();
        piePanel3.revalidate();
        piePanel3.repaint();
        piePanel4.revalidate();
        piePanel4.repaint();
    }
}


class ReportsDailyPanel_jButton3_actionAdapter implements ActionListener {
    private ReportsDailyPanel adaptee;
    ReportsDailyPanel_jButton3_actionAdapter(ReportsDailyPanel adaptee) {
...
class ReportsDailyPanel_jButton2_actionAdapter implements ActionListener {
    private ReportsDailyPanel adaptee;
    ReportsDailyPanel_jButton2_actionAdapter(ReportsDailyPanel adaptee) {
        this.adaptee = adaptee;
    }
...
class ReportsDailyPanel_jButton1_actionAdapter implements ActionListener {
    private ReportsDailyPanel adaptee;
    ReportsDailyPanel_jButton1_actionAdapter(ReportsDailyPanel adaptee) {
        this.adaptee = adaptee;
    }
