 ...
 * @version 0.9.1
 */
public class ReportsYearlyPanel extends JPanel {
    public ReportsYearlyPanel(JFrame parent) {
        this.parent = parent;
    ...
    private void jbInit() throws Exception {
        ...
        jLabel1.setText(I18N.getLabelString("Year")+": ");
        ...
        Border border7 = new TitledBorder(border6, I18N.getLabelString("Sales by Station"));
        ...
        Border border3 = BorderFactory.createEtchedBorder(Color.white,
                new Color(148, 145, 140));
        Border border4 = new TitledBorder(border3, I18N.getLabelString("Sales by User"));
    ...
    private void setDate(Date date) {
        ...
        c.setTime(date);
        YearlyReport dp = new YearlyReport(c.get(Calendar.YEAR));
        ...
        Map.Entry[] stationEntries = Sorter.getSortedHashtableEntries(stationTotals, false);
        ...
        SimpleDateFormat df = new SimpleDateFormat("yyyy");
        report = I18N.getLabelString("Yearly Report")+": " + df.format(date) + "\n\n";
...
class ReportsYearlyPanel_jButton3_actionAdapter implements ActionListener {
    private ReportsYearlyPanel adaptee;
    ReportsYearlyPanel_jButton3_actionAdapter(ReportsYearlyPanel adaptee) {
...
class ReportsYearlyPanel_jButton2_actionAdapter implements ActionListener {
    private ReportsYearlyPanel adaptee;
    ReportsYearlyPanel_jButton2_actionAdapter(ReportsYearlyPanel adaptee) {
        this.adaptee = adaptee;
    }
...
class ReportsYearlyPanel_jButton1_actionAdapter implements ActionListener {
    private ReportsYearlyPanel adaptee;
    ReportsYearlyPanel_jButton1_actionAdapter(ReportsYearlyPanel adaptee) {
        this.adaptee = adaptee;
    }
