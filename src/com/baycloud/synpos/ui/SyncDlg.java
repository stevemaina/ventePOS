            ...
            try {
                ...
                if (freq > 0) {
                    ...
                    JOptionPane.showMessageDialog(this,
                            I18N.getLabelString("Frequency must be greater than zero."),
    ...
    public void jButton3_actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            if (freq > 0) {
                Configuration.set("auto.sync", freqStr);
                JOptionPane.showMessageDialog(this,
                                              I18N.getLabelString("Frequency has been changed."),
                                              I18N.getLabelString("Message"),
                                              JOptionPane.INFORMATION_MESSAGE);
            } else {
                JOptionPane.showMessageDialog(this,
                        I18N.getMessageString("Frequency must be greater than zero."),
                                              I18N.getLabelString("Error"),
                                              JOptionPane.ERROR_MESSAGE);
            }
        } catch (Exception ex) {
