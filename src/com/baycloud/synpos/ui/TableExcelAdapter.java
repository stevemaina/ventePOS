...
/**
 * TableExcelAdapter enables Copy-Paste Clipboard functionality on JTables.
 * The clipboard data format used by the adapter is compatible with
 * the clipboard format used by Excel. This provides for clipboard
 * interoperability between enabled JTables and Excel.
 */
public class TableExcelAdapter implements ActionListener {
    ...
    public TableExcelAdapter(JTable myJTable) {
        jTable1 = myJTable;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getActionCommand().compareTo("Copy") == 0) {
            ...
            if (!((numrows - 1 ==
                ...
                JOptionPane.showMessageDialog(null, I18N.getMessageString("Invalid copy selection."),
        ...
        /*    if (e.getActionCommand().compareTo("Paste") == 0) {
              ...
              try {
         String trstring = (String) (system.getContents(this).getTransferData(
